...
SCENARIO_REGISTRY: dict[str, ScenarioMetadata] = {
    ...
    "energy_grid": ScenarioMetadata(
        ...
        summary="Maintain draining typed nodes by allocating agents to collect and deliver matching resources.",
        communication_role="control",
        private_information="mostly_symmetric",
        ...
        benchmark_tags=("communication_control", "symmetric_information", "resource_allocation"),
        default_presets=(
            ScenarioPreset("core_8x8_easy", map_size=8, num_agents=3, fov_preset="easy", extra={"energy_preset": "easy"}),
            ScenarioPreset("scaled_16x16_hard", map_size=16, num_agents=4, fov_preset="medium", extra={"energy_preset": "hard"}),
        ),
    ),
